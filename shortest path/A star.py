...
lat_start, lon_start = 40.773972, -73.948570 # sostituisci con le tue coordinate di partenza
lat_end, lon_end = 40.760880, -73.929686

  # sostituisci con le tue coordinate di arrivo
...
shortest_path = nx.astar_path(G, source=start_node, target=end_node, heuristic=heuristic, weight='length')
